    ...
    return (
        <div className="max-w-7xl mx-auto px-8 py-12">
            <div className="bg-white rounded-[40px] shadow-[0_10px_50px_rgba(0,0,0,0.05)] border border-[#eaf6f8] p-16">
                <h1 className="text-4xl font-bold text-[#455a64] mb-12">เพิ่มที่อยู่</h1>
                    ...
                    <div className="grid grid-cols-3 gap-12">
                        <div className="space-y-3">
                            ...
                            <div className="relative">
                                <select className="w-full bg-[#f5f7f9] text-[#455a64] border-none rounded-2xl p-4 text-lg focus:ring-2 focus:ring-[#06B6D4] outline-none appearance-none transition-all cursor-pointer">
