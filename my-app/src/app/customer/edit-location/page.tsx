    ...
    return (
        <div className="max-w-7xl mx-auto px-8 py-12">
            <div className="bg-white rounded-[40px] shadow-[0_10px_50px_rgba(0,0,0,0.05)] border border-[#eaf6f8] p-10">
                <h1 className="text-2xl font-bold text-[#455a64] mb-8">แก้ไขที่อยู่</h1>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <div className="space-y-1.5">
                            ...
                            <div className="relative">
                                <select defaultValue="ชลบุรี" className="w-full bg-[#f5f7f9] text-[#455a64] border-none rounded-lg p-2.5 text-sm focus:ring-2 focus:ring-[#06B6D4] outline-none appearance-none transition-all cursor-pointer">
